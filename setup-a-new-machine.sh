...
# markdown to terminal colors
npm install -g cli-md
...
#git clone https://github.com/thebitguru/play-button-itunes-patch ~/code/play-button-itunes-patch   # Not working on El Capitan (Yet?)
...
# I prefer installing pip even for the system python and not only homebrew python
...
mkdir -p ~/bin
ln -sf "$HOME/Applications/Sublime Text.app/Contents/SharedSupport/bin/subl" ~/bin/subl
